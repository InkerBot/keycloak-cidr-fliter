...
public class CidrAddress {
    ...
    public final class SubnetInfo {
         ...
         * addresses by default. Use {@link CidrAddress#setInclusiveHostCount(boolean)} to change this.
         *
        ...
        /**
         * Tests if the parameter <code>address</code> is in the range of usable endpoint addresses for this subnet. This excludes the network and broadcast
         * addresses. Use {@link CidrAddress#setInclusiveHostCount(boolean)} to change this.
         *
     ...
     *                                  0-32
     */
    public CidrAddress(final String cidrNotation) {
     ...
     */
    public CidrAddress(final String address, final String mask) {
    ...
    public CidrAddress getNext() {
        return new CidrAddress(getInfo().getNextAddress(), getInfo().getNetmask());
    }

    public CidrAddress getPrevious() {
        return new CidrAddress(getInfo().getPreviousAddress(), getInfo().getNetmask());
    }
